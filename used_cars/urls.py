...
from .views import CarUploadView, Userdata, CarListByUserView, SearchCarsView, GenerateAvailableSlots, AvailableSlotsByCityDate,create_standard_timeslots, UserProfileFromEmail,BookInspectionSlot
...
urlpatterns = [
    ...
    path('user-profile/', UserProfileFromEmail.as_view(), name='user-profile'),
